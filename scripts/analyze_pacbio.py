    ...
    for strain in s.strains:
        ...
        for sample in s.strains[strain]:
            if sample['platform'] == 'pacbio':
                ...
                no_coverage = join(
                    sample['dir_name'], 'no_alignment_regions.tsv')
        ...
        # Plotting filtered inserted base pairs
        fig = p.subplot_treatments(strain, filtered_inserted_bases)
